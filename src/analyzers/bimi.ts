import { DnsLookupError, queryTxt } from "../dns/client";
import type { TxtRecord } from "../dns/types";
import { parseTags } from "../shared/parse-tags";
import type { BimiResult, Validation } from "./types";
